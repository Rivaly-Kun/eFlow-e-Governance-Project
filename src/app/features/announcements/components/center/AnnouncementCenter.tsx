...
import { Building2, Calendar, Check, CheckCircle2, ChevronRight, Clock, Filter, Globe, Inbox, Info, Mail, MailOpen, Megaphone, Search, Sparkles, Users, X } from 'lucide-react';
...
const AUDIENCE_META: Record<Audience, { label: string; icon: ReactNode; color: string }> = {
  all: {
    label: "Entire LGU",
    icon: <Globe size={11} />,
...
export function AnnouncementCenter({ eyebrow = "My Workspace Â· Updates" }: { eyebrow?: string }) {
